       ...
       <nav class="navbar navbar-expand-lg navbarStyle">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <span class="navbar-text">
                    <img src="../assets/icons8-user-50.png" alt="" width="40" height="40" class="d-inline-block align-text-top">
                    <a class="navLinks">SignUp</a>
                    <img src="../assets/icons8-login-50.png" alt="" width="40" height="40" class="d-inline-block align-text-top">
            ...
            <div class="row ">
                ...
                <div>
                    <div class="footerMediaIcons">
                        <img src="../assets/pngtree-facebook-logo-icon-design-vector-free-logo-design-template-png-image_3652951.png" alt="" width="65" height="62"  class="d-inline-block align-text-top mediaIcons">
                        <img src="../assets/google-symbol-logo-white-design-illustration-with-red-background-free-vector.jpg" alt="" width="42" height="39"  class="d-inline-block align-text-top mediaIcons">
                    </div>
                </div>
                <div class="loginBtnSection">
                    <p>Don't have an account?<a href="../views/signUp.cfm">Register here.</a></p>
                </div>
                </div>
            </div>
        </div>
